...
def detect(
    ...
    for i, (path, img, im0, vid_cap) in enumerate(dataloader):
        ...
        if webcam:  # Show live webcam
            fps = 1 / (time.time() - t)
            cv2.putText(im0, f"FPS:{fps:.2f}", (10,30), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 255, 0), 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', type=int, default=256, help='size of each image dimension')
